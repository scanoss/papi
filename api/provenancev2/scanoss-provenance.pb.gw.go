...
func RegisterProvenanceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProvenanceServer) error {
	mux.Handle(http.MethodPost, pattern_Provenance_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodPost, pattern_Provenance_GetComponentProvenance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "ProvenanceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
