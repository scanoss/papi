...
func request_Provenance_GetComponentOrigin_0(ctx context.Context, marshaler runtime.Marshaler, client ProvenanceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq commonv2.PurlRequest
	var metadata runtime.ServerMetadata
...
func local_request_Provenance_GetComponentOrigin_0(ctx context.Context, marshaler runtime.Marshaler, server ProvenanceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq commonv2.PurlRequest
	var metadata runtime.ServerMetadata
...
func RegisterProvenanceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProvenanceServer) error {
	...
	mux.Handle("POST", pattern_Provenance_GetComponentOrigin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/scanoss.api.provenance.v2.Provenance/GetComponentOrigin", runtime.WithHTTPPathPattern("/api/v2/provenance/origin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Provenance_GetComponentOrigin_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Provenance_GetComponentOrigin_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProvenanceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProvenanceClient) error {
	...
	mux.Handle("POST", pattern_Provenance_GetComponentOrigin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/scanoss.api.provenance.v2.Provenance/GetComponentOrigin", runtime.WithHTTPPathPattern("/api/v2/provenance/origin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Provenance_GetComponentOrigin_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Provenance_GetComponentOrigin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "provenance", "origin"}, ""))
)
...
var (
	...
	forward_Provenance_GetComponentOrigin_0 = runtime.ForwardResponseMessage
)
