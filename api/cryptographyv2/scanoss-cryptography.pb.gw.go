...
var (
	pattern_Cryptography_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "echo"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cryptography_GetAlgorithms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "algorithms"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cryptography_GetAlgorithmsInRange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "algorithmsInRange"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cryptography_GetVersionsInRange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "versionsInRange"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cryptography_GetHintsInRange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "hintsInRange"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cryptography_GetEncryptionHints_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "cryptography", "hints"}, "", runtime.AssumeColonVerbOpt(true)))
)
