...
### Removed
- **Breaking change:** Removed `error_message` and `error_code` fields from `DependencyResponse.Dependencies` message in Dependencies responses. Clients must migrate to `info_message`/`info_code`
